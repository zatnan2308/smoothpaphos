...
/* =========================================================================
   OPTIONS PAGE — 📋 Booking Form Settings
   ========================================================================= */
acf_add_local_field_group( array(
    ...
    'fields'   => array(
        ...
        /* ── Tab: Email ── */
        array(
            'key'       => 'tab_booking_email',
            'label'     => '✉️ Email Settings',
            'name'      => '',
            'type'      => 'tab',
            'placement' => 'top',
            'endpoint'  => 0,
        ...
        array(
            'key'          => 'field_booking_recipient_email',
            'label'        => 'Recipient Email',
            'name'         => 'booking_recipient_email',
            'type'         => 'email',
            'instructions' => 'Booking notifications will be sent to this address. Leave empty to use the WordPress admin email.',
            'placeholder'  => 'diana@smoothstudio.paphos',
        ),

        array(
            'key'           => 'field_booking_email_subject',
            'label'         => 'Email Subject',
            'name'          => 'booking_email_subject',
            'type'          => 'text',
            'default_value' => '[Smooth Studio] New Booking Request',
            'instructions'  => 'Subject line for admin notification emails.',
        ),

        array(
            'key'           => 'field_booking_notify_client',
            'label'         => 'Send Confirmation to Client',
            'name'          => 'booking_notify_client',
            'type'          => 'true_false',
            'default_value' => 1,
            'ui'            => 1,
            'instructions'  => 'When enabled, a confirmation email is automatically sent to the client (requires them to enter their email address).',
        ),

        /* ── Tab: Categories & Services ── */
        array(
            'key'       => 'tab_booking_categories',
        ...
        array(
            ...
            'instructions' => 'Define the categories and services displayed in the booking form. The first category will be selected by default. Leave empty to use built-in defaults.',
            'sub_fields'   => array(
                ...
                array(
                    ...
                    'type'         => 'text',
                    'placeholder'  => 'massage',
                    'instructions' => 'Lowercase, no spaces (e.g. massage, nails, hair). Auto-generated from the name if left empty.',
                    'wrapper'      => array( 'width' => '50' ),
                ),

                array(
                    'key'          => 'field_bcat_services',
                    'label'        => 'Services',
                    'name'         => 'cat_services',
                    'type'         => 'repeater',
                    'layout'       => 'table',
