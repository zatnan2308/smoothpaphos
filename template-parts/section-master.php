<?php
/**
 * Template Part: Master Section — light card layout
 */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
if ( empty( $quote ) ) {
    $quote = '<p>I believe the body knows how to heal — my role is to help it remember.</p>';
}
...
if ( empty( $stats ) ) {
    $stats = array(
        ...
        array( 'number' => 'Premium', 'label' => 'Service' ),
    );
}
?>
        ...
        <div class="master-grid">
            ...
            <div class="master-image-wrap">
                ...
                <div class="master-quote-card">
                    <div class="master-quote-icon">
                        <?php echo smooth_icon( 'heart', 15 ); ?>
                    </div>
                    <blockquote class="master-quote wysiwyg-content">
